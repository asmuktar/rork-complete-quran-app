...
export const HADITH_DATABASE: Hadith[] = [
  ...
  },
  {
    ...
    transliteration: 'Al-muslimu man salima al-muslimuna min lisanihi wa yadihi, wa al-muhajiru man hajara ma naha Allahu \'anhu.',
    grade: 'Sahih',
    book: 'Book of Faith',
  ...
  },
  {
    ...
    transliteration: 'Man kana yu\'minu billahi wa al-yawmi al-akhiri fa-l-yaqul khayran aw li-yasmut, wa man kana yu\'minu billahi wa al-yawmi al-akhiri fa-l-yukrim jarahu, wa man kana yu\'minu billahi wa al-yawmi al-akhiri fa-l-yukrim dayfahu.',
    grade: 'Sahih',
  ...
  },
  {
    ...
    narrator: 'Anas ibn Malik (RA)',
    transliteration: 'Ma min muslimin yaghris gharsan aw yazra\' zar\'an fa-ya\'kul minhu tayrun aw insanun aw bahimatun illa kana lahu bihi sadaqah.',
    grade: 'Sahih',
  ...
  // Sahih Muslim
  {
    ...
    narrator: 'Umar ibn al-Khattab (RA)',
    transliteration: 'Innama al-a\'malu bin-niyyah wa innama li-kulli imri\'in ma nawa.',
    grade: 'Sahih',
    book: 'Book of Faith',
  ...
  },
  {
    ...
    transliteration: 'At-tahuru shatru al-iman wa al-hamdu lillahi tamla\' al-mizan wa subhana Allahi wa al-hamdu lillahi tamla\'ani aw tamla\' ma bayna as-samawati wa al-ard.',
    grade: 'Sahih',
  ...
  },
  {
    ...
    narrator: 'Anas ibn Malik (RA)',
    transliteration: 'Laysa al-mu\'minu alladhi yashba\'u wa jarahu ja\'i\'un ila janbihi.',
    grade: 'Sahih',
  ...
  },
  {
    ...
    narrator: 'Abu Hurairah (RA)',
    transliteration: 'Man naffasa \'an mu\'minin kurbatan min kurab ad-dunya naffasa Allahu \'anhu kurbatan min kurab yawm al-qiyamah.',
    grade: 'Sahih',
